package cat.itacademy.barcelonactiva.diazdiaz.dani.s04.t02.n02.model.services;

import cat.itacademy.barcelonactiva.diazdiaz.dani.s04.t02.n02.model.domain.Fruita;
import cat.itacademy.barcelonactiva.diazdiaz.dani.s04.t02.n02.model.repository.FruitaRepository;
...
public class FruitaService {
    ...
    public Fruita updateFruita(Fruita fruita) {
        ...
        if (optionalFruita.isPresent()) {
            ...
            throw new RuntimeException("Error al actualizar la fruita");
        }
    }
    ...
    public boolean deleteFruita(int id) {
        ...
        try {
            ...
            System.out.println("No se ha podido borrar la fruita");
            isDeleted = false;
        }
        return isDeleted;
    }
